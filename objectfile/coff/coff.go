...
//   - coff.TargetWindowsX86   → IMAGE_FILE_MACHINE_I386  (0x014C)
//
// File layout
//
//	┌─────────────────────────────────────┐
...
//
// i386 caveat: this package never mangles Symbol.Name. Classic MSVC/Win32
// calling-convention decoration for 32-bit x86 — a leading underscore for
// cdecl/stdcall, a trailing "@N" byte count for stdcall, a leading "@" for
// fastcall — is the caller's responsibility to bake into Symbol.Name and
// Reloc.Symbol before handing them to this package. AMD64 and ARM64 COFF
// have no such decoration, so this only matters for TargetWindowsX86.
package coff
...
const (
	machineI386  uint16 = 0x014C // IMAGE_FILE_MACHINE_I386
...
// The target must be TargetWindowsAMD64, TargetWindowsARM64, or
// TargetWindowsX86; any other Arch defaults to AMD64.
