...
`github.com/vertex-language/arc/objectfile`
...
```sh
go get github.com/vertex-language/arc/objectfile
```
...
```go
import "github.com/vertex-language/arc/objectfile/elf"    // Linux, *BSD, freestanding
import "github.com/vertex-language/arc/objectfile/coff"   // Windows
import "github.com/vertex-language/arc/objectfile/macho"  // Darwin
import "github.com/vertex-language/arc/objectfile/flat"   // raw binary, no header
```
