...
ELF64 linker sub-package for `github.com/vertex-language/arc/linker`.
...
```go
import "github.com/vertex-language/arc/linker/elf"

// blank-import whichever arch backends you need registered:
import (
    _ "github.com/vertex-language/arc/linker/elf/x86_64"
    _ "github.com/vertex-language/arc/linker/elf/aarch64"
)
```
