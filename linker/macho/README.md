...
Mach-O sub-package for `github.com/vertex-language/arc/linker`. This
...
```go
import "github.com/vertex-language/arc/linker/macho"

// blank-import whichever arch backends you need registered:
import (
    _ "github.com/vertex-language/arc/linker/macho/x86_64"
    _ "github.com/vertex-language/arc/linker/macho/arm64"
    _ "github.com/vertex-language/arc/linker/macho/arm64e"
    _ "github.com/vertex-language/arc/linker/macho/arm64_32"
)
```
...
## Code signing (`github.com/vertex-language/arc/linker/macho/codesign`)
...
```go
import "github.com/vertex-language/arc/linker/macho/codesign"
```
