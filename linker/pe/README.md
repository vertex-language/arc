...
PE sub-package for `github.com/vertex-language/arc/linker`. This package
...
```go
import "github.com/vertex-language/arc/linker/pe"

// blank-import whichever arch backends you need registered:
import (
    _ "github.com/vertex-language/arc/linker/pe/x64"
    _ "github.com/vertex-language/arc/linker/pe/aarch64"
    _ "github.com/vertex-language/arc/linker/pe/arm64ec"
)
```
