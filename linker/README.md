...
`github.com/vertex-language/arc/linker` — container-format backends
...
| `os` | Import |
|---|---|
| `linux`, `freebsd`, `netbsd`, `openbsd`, `android`, `none` | `github.com/vertex-language/arc/linker/elf` |
| `macos`, `ios`, `ios-simulator`, `maccatalyst`, `tvos`, `watchos`, `watchos-simulator`, `bridgeos`, `driverkit`, `visionos`, `visionos-simulator` | `github.com/vertex-language/arc/linker/macho` |
| `windows`, `uefi` | `github.com/vertex-language/arc/linker/pe` |
